...
const tabs = [
  { icon: Gamepad2, label: "Games", activeColor: "#00a2e8" },
  { icon: Store, label: "Market", activeColor: "#00a2e8" },
  { icon: Gift, label: "Earn", activeColor: "#00a2e8" },
  { icon: Users, label: "Invite", activeColor: "#00a2e8" },
  { icon: Wallet, label: "Wallet", activeColor: "#00a2e8" },
];
...
const BottomNav = ({ activeTab, onTabChange }: BottomNavProps) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-[#0e131f] border-t border-white/[0.03]">
